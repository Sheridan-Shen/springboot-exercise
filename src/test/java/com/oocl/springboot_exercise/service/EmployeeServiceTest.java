...
//
//        when(employeeMemoryRepository.addEmployee(any(Employee.class))).thenReturn(mockEmployee);
//
//        // 模拟输出的结果
...
//        when(employeeMemoryRepository.removeEmployee(1)).thenReturn(inputEmployee);
//    }
//
//    @Test
...
//
//        // 模拟输出
//        when(employeeMemoryRepository.getEmployeeById(nonExistentId)).thenReturn(null);
//
//        // 执行
...
//
//        // 验证repository方法被调用
//        verify(employeeMemoryRepository, times(1)).getEmployeeById(nonExistentId);
//    }
//
//    @Test
...
//        }
//        when(employeeMemoryRepository.getEmployees()).thenReturn(employeeMap);
//
//        // 执行
...
//
//        // 验证repository方法被调用
//        verify(employeeMemoryRepository, times(1)).getEmployees();
//    }
//
//    @Test
//    void should_return_empty_list_when_no_employees_exist() {
//        // 模拟repository返回空map
//        when(employeeMemoryRepository.getEmployees()).thenReturn(new HashMap<>());
//
//        // 执行
//        List<Employee> result = employeeService.getAllEmployees();
//
...
//
//        // 模拟输出
//        when(employeeMemoryRepository.getEmployeeById(employeeId)).thenReturn(existingEmployee);
//
//        // 执行
...
//
//        // 验证repository方法被调用
//        verify(employeeMemoryRepository, times(1)).getEmployeeById(employeeId);
//
//    }
//
//    @Test
...
//
//        // 模拟输出
//        when(employeeMemoryRepository.getEmployeeById(employeeId)).thenReturn(inactiveEmployee);
//
//        // 执行并验证异常
...
//        // 验证repository方法调用
//        verify(employeeMemoryRepository, times(1)).getEmployeeById(employeeId);
//        verify(employeeMemoryRepository, never()).updateEmployee(anyInt(), any(Employee.class));
//    }
//
//    @Test
...
//        // 模拟输出
//        when(employeeMemoryRepository.getEmployeeById(employeeId)).thenReturn(existingEmployee);
//        doNothing().when(employeeMemoryRepository).updateEmployee(eq(employeeId), any(Employee.class));
//
//        // 执行
...
//        // 验证repository方法被调用
//        verify(employeeMemoryRepository, times(1)).getEmployeeById(employeeId);
//        verify(employeeMemoryRepository, times(1)).updateEmployee(eq(employeeId), eq(employeeToSave));
//    }
//
//    @Test
...
//
//        // 验证repository方法被调用
//        verify(employeeMemoryRepository, times(2)).getEmployees(); // 被调用3次（初始+2次分页）
//    }
//
//    @Test
